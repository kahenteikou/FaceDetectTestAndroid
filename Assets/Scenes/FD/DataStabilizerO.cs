    ...
    interface IDataStabilizer<T>
    {
        ...
        /// </summary>
        DataStabilizerParamsO Params { get; set; }
    ...
    abstract class DataStabilizerBase<T>
    {
        ...
        /// Parameters, see corresponding class
        /// </summary>
        public DataStabilizerParamsO Params { get; set; }
        ...
        /// </summary>
        protected DataStabilizerBase(DataStabilizerParamsO parameters)
        {
            Params = parameters;
    ...
    class PointsDataStabilizer : DataStabilizerBase<Point[]>
    {
        ...
        public PointsDataStabilizer(DataStabilizerParamsO parameters)
            : base(parameters)
        {
    ...
    class RectStabilizer : DataStabilizerBase<Rect>
    {
        ...
        public RectStabilizer(DataStabilizerParamsO parameters)
            : base(parameters)
        {}
