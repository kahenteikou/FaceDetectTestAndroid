	...
	class DetectedObject
    {
        ...
        public DetectedObject(DataStabilizerParamsO stabilizerParameters)
        {
        ...
        /// /// <param name="stabilizerParameters">Data stabilizer params</param>
        public DetectedObject(DataStabilizerParamsO stabilizerParameters, String name, Rect region)
        ...
        /// /// <param name="stabilizerParameters">Data stabilizer params</param>
        public DetectedObject(DataStabilizerParamsO stabilizerParameters, String name, OpenCvSharp.Point[] marks)
            : this(stabilizerParameters)
        {
            Name = name;
    ...
    /// </summary>
    class DetectedFaceO : DetectedObject
    {
        /// <summary>
        /// Face elements
        /// </summary>
        ...
        /// /// <param name="stabilizerParameters">Data stabilizer params</param>
        public DetectedFaceO(DataStabilizerParamsO stabilizerParameters, Rect roi)
